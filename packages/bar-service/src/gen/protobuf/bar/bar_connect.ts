// @generated by protoc-gen-connect-es v0.7.0 with parameter "target=ts,import_extension=.ts"
// @generated from file protobuf/bar/bar.proto (package ebf.bar.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck

import { BiStreamingRequest, BiStreamingResponse, ClientStreamRequest, ClientStreamResponse, ServerStreamRequest, ServerStreamResponse, UnaryRequest, UnaryResponse } from "./bar_pb.ts";
